...
const RegisterRoomPublicBedTypes: React.FC = () => {
    ...
    const totalBedsCount = useMemo(() => {
     ...
     const [activatedBedOptions, setActivatedOptions] = useState<BedType[]>(initialBedOptions);

     const lastBedOptions = useMemo(() => {
         return bedTypes.filter((bedType) => !activatedBedOptions.includes(bedType));
     }, [activatedBedOptions, publicBedList]);
             ...
             {opened && (
                 <div className="register-room-public-bed-type-counters">
                     ...
                     <Selector
                         ...
                         useValidation={false}
                         onChange={(e) => {
                             setActivatedOptions([...activatedBedOptions, e.target.value as BedType])}
                         }
                     />
                 </div>
             )}
