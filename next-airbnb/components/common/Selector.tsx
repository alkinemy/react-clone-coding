...
interface SelectorType extends React.SelectHTMLAttributes<HTMLSelectElement> {
    options?: string[];
...
const Selector: React.FC<SelectorType> = ({options = [], disabledOptions = [], isValid, ...props}) => {
    const validateMode = useSelector((state) => state.common.validateMode);
    return (
        <Container validateMode={validateMode} isValid={!!isValid}>
            <select {...props}>
